...
<div class="row align-items-center">
  ...
  <p>Dr. Huang has received several awards recognizing his research contributions, including ACM SIGDA Outstanding PhD Dissertation Award, NSF CAREER Award, Humboldt Research Fellowship, ACM SIGDA Outstanding New Faculty Award, ICCAD 10-Year Most Influential Paper Award (OpenTimer), DAC Under-40 Innovator Award, Vilas Early-career Investigator Award, and IEEE HPEC Outstanding Paper Award. He also won championships in multiple programming and research competitions, including the ACM SIGDA SRC, ACM SIGDA CADathlon, ACM TAU Contest, and IEEE HPEC Graph Challenge.
  Dr. Huang has served on the TPC in DAC, ICCAD, MICRO, ASPLOS, HPCA, SC, IPDPS, etc.</p>
  </div>
</div>
