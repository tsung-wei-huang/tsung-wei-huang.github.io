...
\begin{minipage}[c]{0.6\textwidth}
    ...
    \small{} \\
    \href{mailto:tsung-wei.huang@utah.edu}{\hspace{5pt} tsung-wei.huang@utah.edu}\\
...
\textbf{High-performance Computing, Computer-aided Design, Quantum Computing}{}
...
%      {Institution of Study}{Where it is located}
    ...
    \CVSubheading
      ...
      {PI, \$298K, NSF, TI-2229304}{Sep 2022 -- Aug 2024}
    \CVSubheading
...
\section{Conference Publication}
 ...
 \itemsep-3pt
    ...
    \item Takashi Sato, Chun-Yao Wang, Yu-Guang Chen, and \underline{Tsung-Wei Huang}, ``Overview of CAD Contest at ICCAD,'' \textit{IEEE/ACM International Conference on Computer-aided Design (ICCAD)}, San Diego, 2023
...
\section{Talk}
 ...
 \itemsep-0.3em
  ...
  \item ``Quantum Circuit Simulation with Incrementality,'' NSF FuSe Workshop, Buffalo, June 2023
  \item ``Intelligent High-performance Computing,'' Technical University of Munich Seminar, June 2023
  \item ``Taskflow: A General-purpose Task-parallel Programming System,'' Notre Dame CSE, May 2023
