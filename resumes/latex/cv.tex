...
%      {Institution of Study}{Where it is located}
    \CVSubheading
      {{Assistant Professor, Department of Electrical and Computer Engineering}}{Aug 2023 -- present}
      {University of Wisconsin at Madison, Madison, Wisconsin, USA}{}
    \CVSubheading
      {{Assistant Professor, Department of Electrical and Computer Engineering}}{July 2019 -- Aug 2023}
...
\textbf{Computer-aided Design, High-performance Computing, Quantum Computing}{}
...
\section{Journal Publication}
 \begin{enumerate}
 \itemsep-3pt
  \item Zizheng Guo, \underline{Tsung-Wei Huang}, and Yibo Lin, ``Accelerating Static Timing Analysis using CPU-GPU Heterogeneous Parallelism,'' \textit{IEEE Transactions on Computer-aided Design of Integrated Circuits and Systems (TCAD)}, to appear
...
\section{Talk}
 \begin{enumerate}
 \itemsep-0.3em
  \item ``Taskflow: A General-purpose Task-parallel Programming System,'' Chinese University of Hong Kong (CUHK), Jan 2024
  \item ``Taskflow: A General-purpose Task-parallel Programming System,'' China University of Petroleum, Oct 2023
  ...
  \item ``Taskflow: A General-purpose Task-parallel Programming System,'' University of Notre Dame, May 2023
  ...
  \item ``Programming System for Building High-performance CAD Applications,'' Google X Moonshot Factory, Sep 2022
  \item ``A General-purpose Parallel and Heterogeneous Task Programming System,'' AMD Xilinx/Vivado, Aug 2022
  ...
  \item ``Taskflow: A General-purpose Heterogeneous Task Computing System,'' Chinese University of Hong Kong (CUHK), Aug 2021
...
\section{Service}
  \CVSubHeadingListStart
    ...
    \CVSubheading
      ...
      \CVItemListStart
        \CVItem{IEEE International Parallel and Distributed Processing Symposium (IPDPS), 2023}
