...
\textbf{High-performance Computing, Quantum Computing, Computer-aided Design}{}
  

\section{Software Project}
  {Our software projects have been downloaded over \textit{1.5M times} and used by many organizations:}{}
  \CVSubHeadingListStart
    
    \CVSubheading
      {Taskflow}{https://taskflow.github.io/}
      {A general-purpose parallel and heterogeneous programming system}{}
      \CVItemListStart
        \CVItem{MIT/Amazon/HPEC Graph Challenge Champion Award, 2020}
        \CVItem{ACM Multimedia Best Open-source Software Award, 2019}
        \CVItem{C++ Conference Best Poster Award in Parallelism, 2018}
      \CVItemListEnd
    
    \CVSubheading
      {qTask}{\hspace{-10em}https://arxiv.org/abs/2210.01076}
      {A task-parallel quantum circuit simulator with incrementality}{}
      \CVItemListStart
        \CVItem{The first quantum circuit simulator supporting incrementality}
      \CVItemListEnd
    
    \CVSubheading
      {OpenTimer}{\hspace{-10em}https://github.com/OpenTimer}
      ...
      \CVItemListStart
        ...
        \CVItem{Golden Timers of ACM TAU Contests, 2014--2016}
        \CVItem{Golden Timer of IEEE/ACM ICCAD CAD Contest, 2015}
      \CVItemListEnd
    
    \CVSubheading
      {SNIG}{\hspace{-10em}https://github.com/dian-lun-lin/SNIG}
      {A task-parallel inference engine for large sparse neural network}{}
      \CVItemListStart
        \CVItem{MIT/Amazon/HPEC Graph Challenge Champion Award, 2020}
      \CVItemListEnd
    
    \CVSubheading
      {DtCraft}{\hspace{-10em}https://github.com/twhuang-uiuc/DtCraft}
      {A data-parallel distributed streaming system}{}
      \CVItemListStart
...
\section{Awards}
 ...
 \itemsep-3pt
    ...
    \item Champion of the MIT/Amazon/HPEC Large Sparse Neural Network Challenge, 2020
