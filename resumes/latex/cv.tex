...
\section{Conference Publication}
 \begin{enumerate}
 \itemsep-3pt
    \item Wan-Luan Lee, Dian-Lun Lin, Cheng-Hsiang Chiu, Ulf Schlichtmann, and \underline{Tsung-Wei Huang}, ``HyperG: Multilevel GPU-Accelerated k-way Hypergraph Partitioner,'' \textit{IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC)}, Tokyo, Japan, 2025
    \item Boyang Zhang, Che Chang, Cheng-Hsiang Chiu, Dian-Lun Lin, Yang Sui, Chih-Chun Chang, Yi-Hua Chung, Wan-Luan Lee, Zizheng Guo, Yibo Lin, and \underline{Tsung-Wei Huang}, ``iTAP: An Incremental Task Graph Partitioner for Task-parallel Static Timing Analysis,'' \textit{IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC)}, Tokyo, Japan, 2025
    \item Che Chang, Boyang Zhang, Cheng-Hsiang Chiu, Dian-Lun Lin, Yi-Hua Chung, Wan-Luan Lee, Zizheng Guo, Yibo Lin, and \underline{Tsung-Wei Huang}, ``PathGen: An Efficient Parallel Critical Path Generation Algorithm,'' \textit{IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC)}, Tokyo, Japan, 2025
    ...
    \item Chedi Morchdi, Cheng-Hsiang Chiu, Yi Zhou, and \underline{Tsung-Wei Huang}, ``A Resource-efficient Task Scheduling System using Reinforcement Learning,'' \textit{IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC)}, Korea, 2024
