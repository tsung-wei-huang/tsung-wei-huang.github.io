...
%      {Institution of Study}{Where it is located}
    \CVSubheading
      {{Postdoc, Department of Electrical and Computer Engineering }}{2018 -- 2018}
      {University of Illinois at Urbana-Champaign, IL, USA}{}
    \CVSubheading
...
\section{Awards}
 \begin{itemize}
 \itemsep-3pt
    \item Outstanding Paper Award (5 out of 145 papers), IEEE HPEC, 2026
    \item Ernest S. Kuh Early Career Award, IEEE Council of Electronic Design Automation (CEDA), 2026
...
\section{Conference Publication}
 ...
 \itemsep-3pt
    ...
    \item \textbf{[ASPLOS'27]} Yi-Hua Chung, Hao-Hsiang Hsiao, Cheng-Hsiang Chiu, Boyang Zhang, Che Chang, Joshua San Miguel, and \underline{Tsung-Wei Huang}, ``XEG: A GPU-Parallel Algorithm for Efficient and Effective E-Graph Extraction,'' \textit{ACM International Conference on Architectural Support for Programming Languages and Operating Systems (ASPLOS)}, Heraklion, Crete, Greece, 2027
    
    \item \textbf{[CGO'27]} Chih-Chun Chang, Aditya Das Sarma, Cheng-Hsiang Chiu, and \underline{Tsung-Wei Huang}, ``Can ML Frameworks Go Beyond ML? A Case Study in GPU-accelerated VLSI Timing Analysis,'' \textit{IEEE/ACM International Symposium on Code Generation and Optimization (CGO)}, Salt Lake City, UT, 2027

    \item \textbf{[PACT'26]} Shui Jiang, Hengrui Chen, Tsung-Yi Ho, and \underline{Tsung-Wei Huang}, ``Q-TranSim: Batch Quantum Circuit Simulation using Tensor Transpilation,'' \textit{ACM International Conference on Parallel Architectures and Compilation Techniques (PACT)}, Chicago, Illinois, 2026

    \item \textbf{[MICRO'26]} Xiangyu Ren, Yuexun Huang, Zhaohui Yang, Yuchen Zhu, \underline{Tsung-Wei Huang}, Tsung-Yi Ho, Zhiding Liang, and Antonio Barbalace, ``A Spatial-Topology Preserving Compiler for Quantum Many-Body Systems Simulation,'' \textit{IEEE/ACM International Symposium on Microarchitecture (MICRO)}, Athens, Greece, 2026

    \item \textbf{[Euro-Par'26]} Boyang Zhang, Chih-Chun Chang, Yi-Hua Chung, Che Chang, Cheng-Hsiang Chiu, Aditya Das Sarma, and \underline{Tsung-Wei Huang}, ``G-STAR: GPU-Accelerated Statistical Static Timing Analysis using Level-by-level Replication,'' \textit{International European Conference on Parallel and Distributed Computing (Euro-Par)}, Pisa, Italy, 2026

    \item \textbf{[Euro-Par'26]} Zhengxiong Li, \underline{Tsung-Wei Huang}, and Umit Ogras, ``SET: Stream-Event-Triggered Scheduling for Efficient CUDA Graph Pipelines,'' \textit{International European Conference on Parallel and Distributed Computing (Euro-Par)}, Pisa, Italy, 2026
    
    \item \textbf{[ICS'26]} Che Chang, Yi-Hua Chung, Cheng-Hsiang Chiu, Wan-Luan Lee, Boyang Zhang, Ulf Schlichtmann, Ing-Chao Lin, Xiangyao Yu, and \underline{Tsung-Wei Huang}, ``G-PathGen: An Efficient GPU-Parallel k-Critical Path Generation Algorithm,'' \textit{ACM International Conference on Supercomputing (ICS)}, Belfast, Northern Ireland, UK, 2026
    
    \item \textbf{[DAC'26]} Aditya Das Sarma, Wan-Luan Lee, Shui Jiang, Boyang Zhang, and \underline{Tsung-Wei Huang}, ``A Differentiable Approach to Task Graph Partitioning: A Case Study in RTL Simulation,'' \textit{ACM/IEEE Design Automation Conference (DAC)}, Long Beach, CA, 2026
    
    \item \textbf{[DAC'26]} Wan-Luan Lee, Aditya Das Sarma, Che Chang, Chih-Chun Chang, and \underline{Tsung-Wei Huang}, ``iHyperG: Incremental Hypergraph Partitioning on GPU,'' \textit{ACM/IEEE Design Automation Conference (DAC)}, Long Beach, CA, 2026

    \item \textbf{[DAC'26]} Pingchuan Ma, Ziang Yin, Qi Jing, Zhengqi Gao, Nicholas Gangi, Boyang Zhang, \underline{Tsung-Wei Huang}, Rena Huang, Duane Boning, Yu Yao, and Jiaqi Gu, ``SP2RINT: Spatially-Decoupled Physics-Constrained Progressive Inverse Optimization for Diffractive Optical Neural Network Training,'' \textit{ACM/IEEE Design Automation Conference (DAC)}, Long Beach, CA, 2026
...
\section{Journal Publication}
 ...
 \itemsep-3pt
  ...
  \item \textbf{[TODAES'26]} Che Chang, Boyang Zhang, Cheng-Hsiang Chiu, Dian-Lun Lin, Yi-Hua Chung, Wan-Luan Lee, Zizheng Guo, Yibo Lin, and \underline{Tsung-Wei Huang}, ``C-PathGen: An Efficient CPU-Parallel Critical Path Generation Algorithm,'' \textit{ACM Transactions on Design Automation of Electronic Systems (TODAES)}, accepted, 2026
  
  \item \textbf{[TQC'26]} Shui Jiang, Hengrui Chen, Tsung-Yi Ho, and \underline{Tsung-Wei Huang}, ``FlatDD: Parallel Quantum Circuit Simulation using Decision Diagram and Flat Array,'' \textit{ACM Transactions on Quantum Computing (TQC)}, accepted, 2026
  
  \item \textbf{[TCAD'26]} Chih-Chun Chang, Yi-Hua Chung, Wan-Luan Lee, Boyang Zhang, and \underline{Tsung-Wei Huang}, ``SSTA-X: GPU-Accelerated First-Order Block-Based Statistical Static Timing Analysis,'' \textit{IEEE Transactions on Computer-aided Design of Integrated Circuits and Systems (TCAD)}, accepted, 2026
  
  \item \textbf{[TCAD'26]} Shui Jiang, Wen Cheng, Yi-Hua Chung, Tsung-Yi Ho, and \underline{Tsung-Wei Huang}, ``QDP: Worst-case Fidelity-aware Qubit Mapping and Routing using Dynamic Programming,'' \textit{IEEE Transactions on Computer-aided Design of Integrated Circuits and Systems (TCAD)}, accepted, 2026
...
\section{Talk}
 \begin{enumerate}
 \itemsep-0.3em
  \item ``Dynamic Asynchronous Tasking with Dependencies,'' CppOnline, April 2026
...
\section{Ph.D. Students}
  \CVSubHeadingListStart
    \CVSubheading
      ...
      {Thesis: A System Stack for High-Performance Quantum Circuit Simulation}{}
    \CVSubheading
    ...
    \CVSubheading
      ...
      {Thesis: TBD}{}
    \CVSubheading
      {{Zhengxiong Li (co-supervised with Prof. Umit Y. Ogras)}}{Fall 2025 -- present}
      {Thesis: TBD}{}
    \CVSubheading
      {{Zixuan Zhou}}{Fall 2026 -- present}
      {Thesis: TBD}{}
  \CVSubHeadingListEnd
...
\section{Service}
  \CVSubHeadingListStart
    ...
    \CVSubheading
      ...
      \CVItemListStart
        \CVItem{Award Committee, 2026--Now}
        \CVItem{Tenure and Promotion Committee, 2026--Now}
